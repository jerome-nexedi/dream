...
#                                 print self.env.now, station.id, 'releases', operator.id
...
#                             print station.name,station.isProcessing,station.currentOperator
#                             if (not station.isProcessing) and station.currentOperator:
#                                 print self.env.now, station.id, 'releases', operator.id
#                                 station.releaseOperator()  
